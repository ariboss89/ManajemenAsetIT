 ...
 * @author casperx
 */
public class FormRequestPurchasing extends javax.swing.JDialog {

    ReqPurchasing prc = new ReqPurchasing();
    Table tbl = new Table();
    private int a;
    private String rs[][];
    ...
    public FormRequestPurchasing(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        initUI();
    ...
    private void Refresh() {
        IdDetail();
        IdPurchasing();
        rs = prc.ShowData(prc.getIdPurchasing());
    ...
    private void IdDetail() {
        ...
        try {
            ...
            ResultSet rs = st.executeQuery("select *from reqpurchasingdetail ORDER BY iddetail DESC");
            if (rs.next()) {
                String nocust = rs.getString("iddetail").substring(4);
                ...
                prc.setIdDetail("PRDT" + Nol + AN);
            } else {
                prc.setIdDetail("PRDT0001");
            }
        } catch (Exception e) {
    ...
    private void IdPurchasing() {

        java.sql.Connection conn = new Koneksi().connect();
        try {
            Statement st = conn.createStatement();
            ResultSet rs = st.executeQuery("select *from reqpurchasing ORDER BY idreqpurchasing DESC");
            if (rs.next()) {
                String nocust = rs.getString("idreqpurchasing").substring(4);
                String AN = "" + (Integer.parseInt(nocust) + 1);
                String Nol = "";
                if (AN.length() == 1) {
                    Nol = "000";
                ...
                prc.setIdPurchasing("PRCH" + Nol + AN);
            } else {
                prc.setIdPurchasing("PRCH0001");
            }
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, e);
        }
    ...
    private void SumJumlah() {
        ...
        for (int i = 0; i < rowcount; i++) {
            prc.setSum(jTable1.getModel().getValueAt(i, 3).toString());
            a = a + Integer.valueOf(prc.getSum());
        }
        prc.setSum(String.valueOf(a));
    }
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Request Purchasing");
    ...
    private void btnokActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnokActionPerformed
        ...
        String idDetail = prc.getIdDetail();
        String idReqAsset = prc.getIdPurchasing();
        String kodeBarang = txtKode.getText();
        int jml = Integer.parseInt(txtJumlah.getText());
        prc.setStatus("On Waiting");
        String status = prc.getStatus();
        ...
        if (kodeBarang.equals("")) {
            ...
            prc.SaveDetail(idDetail, idReqAsset, kodeBarang, jml, status);
            Refresh();
        }
    ...
    private void btnsaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsaveActionPerformed
        ...
        SumJumlah();
        String idsupplier = prc.getIdSupplier();
        String idpetugas = Login.getId();

        prc.Save(idreqasset, tanggal, a, idsupplier, idpetugas);
        IdPurchasing();
        Refresh();
    ...
    private void txtKodeKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtKodeKeyReleased
        ...
        try {
            ...
            while (res.next()) {
                ...
                prc.setIdBarang(res.getString("id"));
            }
        } catch (SQLException ex) {
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        prc.setIdDetail(jTable1.getValueAt(row, 0).toString());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormRequestPurchasing.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            FormRequestPurchasing dialog = new FormRequestPurchasing(new javax.swing.JFrame(), true);
