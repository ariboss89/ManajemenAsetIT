 ...
 * @author User
 */
public class FormRiwayatAsset extends javax.swing.JFrame {

    RiwayatAsset ast = new RiwayatAsset();
    Table tbl = new Table();
    private int a;
    private String rs[][];
    ...
    int[] lebar2 = {300, 300, 600, 400};
    /**
     * Creates new form FormKaryawan1
     */
    public FormRiwayatAsset() {
        initComponents();
    ...
    private void ShowNama(){
        ...
        try{
            ...
            java.sql.ResultSet res = stmt.executeQuery("select *from tmsupplier where kode = '"+ast.getId()+"'");
            while(res.next()){
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Data Riwayat Asset");
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        ast.setId(jTable1.getValueAt(row, 3).toString());
        ShowNama();
        btnsave.setEnabled(true);
        
        rs2 = ast.ShowDetailData(txtId.getText());
    ...
    private void btnsaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsaveActionPerformed
        ...
        try {
            ...
            File file = new File("src/inventori_barang/app/report/NotaAsset.jasper");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormRiwayatAsset.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormRiwayatAsset().setVisible(true);
            }
        });
    }
